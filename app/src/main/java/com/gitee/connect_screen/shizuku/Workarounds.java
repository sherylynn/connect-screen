...
public final class Workarounds {
    ...
    private static void fillAppInfo() {
        try {
            ...
            Log.d("UserService","Could not fill app info: " + throwable.getMessage());
        }
    }
    ...
    private static void fillAppContext() {
        try {
            ...
            // this is a workaround, so failing is not an error
            Log.d("UserService","Could not fill app context: " + throwable.getMessage());
        }
    }
    ...
    private static void fillConfigurationController() {
        try {
            ...
            Log.d("UserService","Could not fill configuration: " + throwable.getMessage());
        }
    }
    ...
    static Context getSystemContext() {
        try {
            ...
            // this is a workaround, so failing is not an error
            Log.d("UserService","Could not get system context: " + throwable.getMessage());
            return null;
        }
    }
}